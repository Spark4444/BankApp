...
const convert = async () => {
    const UA_US = await convertCurrency("1","USD","UAH");
    const UA_EU = await convertCurrency("1","EUR","UAH");
...
const replaceNaN = (input, replacement) => {
    return input.replace(/NaN/g, replacement);
};
